...
from .app import Stage2Config, run_stage2


def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="Stage 2 (최종 조립 및 검증) - Raspberry Pi Jig Program")
